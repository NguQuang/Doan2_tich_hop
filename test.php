...
<head>
    ...
    <style type="text/css">
        ...
        .microphone-button {
            background-image: url('https://png.pngtree.com/png-vector/20221120/ourmid/pngtree-record-microphone-mic-vector-icon-radio-illustration-button-vector-png-image_41952372.jpg'); /* Replace with the path to your microphone image */
            ...
            transition: opacity 0.3s ease; /* Add a smooth hover effect */
        }

        .microphone-button:hover {
            opacity: 1; /* Change opacity on hover to make the button more prominent */
        }
    </style>
</head>
<body>
        ...
        <div class="container">
            <div class="background-form">
                ...
                <form method = "post" name = "form1" id = "form_input">
                    <div class = "container">
                        ...
                        <div class="row">
                          ...
                          <p class="col-2">                    
                          <button class="btn btn-info microphone-button" type="button" id="btnVoice" name="btnVoice"></button>
                          </p>
                        </div>
                        <div clas = "row">
                ...
                <form name = "form2" id = "form_input">
                                          ...
                                          echo "
                                              <div class = 'form-group text-left' style = 'font-size: 13px'>
                                                  ...
                                                  <div class = 'form-check form-check-inline'>
                                                      ...
                                                      <label style = 'font-size: 15px' class = 'text-center'> Relevant </label>
                                                  </div>
                                                  <div class = 'form-check form-check-inline'>
                                                      <input type = 'radio' class = 'form-check-input' name = 'danhgia$x' id = 'delivery$x' value  = 'disagree' checked>
                                                      <label style = 'font-size: 15px'> Irrelevant </label>
                                                  </div>
                                              </div> </td> ";
                                              } 
                                          }
                                          ...
                                          for($x = 10; $x < 15; $x++){ 
                                              ...
                                              echo "
                                                  <div class = 'form-group text-left' style = 'font-size: 13px'>
                                                      ...
                                                      <div class = 'form-check form-check-inline'>
                                                          <input type = 'radio' class = 'form-check-input' name = 'danhgia$x' id = 'delivery$x' value  = 'agree'>
                                                          <label style = 'font-size: 15px' class = 'text-center'> Relevent </label>
                                                      </div>
                                                      <div class = 'form-check form-check-inline'>
                                                          <input type = 'radio' class = 'form-check-input' name = 'danhgia$x' id = 'delivery$x' value  = 'disagree' checked>
                                                          <label style = 'font-size: 15px'> Irrelevant </label>
                    ...
                    <div class = "container">
                        <div class = "row">
                            <button type = "submit" id = "btnPrint" class = "col-sm-3 btn btn-info" name = "Submit" > SEND FEEDBACK RESULTS  </button> 
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            document.getElementById("queryStr").value = response;
        },
